create user joao with superuser password '1234'; 
...
CREATE SCHEMA hr AUTHORIZATION joao;	
...
COMMENT ON TABLE regioes IS 'Contém número e nome das regiões';
COMMENT ON COLUMN regioes.id_regiao IS 'Chave primária da tabela regiões.';
COMMENT ON COLUMN regioes.nome IS 'Nome da regiões';
...
COMMENT ON TABLE paises IS 'Contém as informações dos países';
COMMENT ON COLUMN paises.id_pais IS 'Chave primária da tabela países.';
COMMENT ON COLUMN paises.nome IS 'Nome de cada país';
...
COMMENT ON COLUMN localizacoes.cep IS 'CEP de um escritório ou facilidade da empresa';
COMMENT ON COLUMN localizacoes.cidade IS 'Cidade que se localiza o escritório ou facilidade da empresa';
COMMENT ON COLUMN localizacoes.uf IS 'UF que se localiza um escritório ou facilidade da empresa';
...
COMMENT ON TABLE cargos IS 'Tabela que armazena cargos e faixa salarial, contendo mínimo e máximo para cada cargo';
COMMENT ON COLUMN cargos.id_cargo IS 'chave primaria da tabela';
COMMENT ON COLUMN cargos.cargo IS 'nomde do cargo';
COMMENT ON COLUMN cargos.salario_minimo IS 'menor salário possivel para um cargo';
COMMENT ON COLUMN cargos.salario_maximo IS 'maior salario possivel para um cargo';
...
COMMENT ON COLUMN empregados.comissao IS 's quem trabalha no departamento de vendas';
COMMENT ON COLUMN empregados.id_supervisor IS 'Chave primária da tabela.';
COMMENT ON COLUMN empregados.id_departamento IS 'chave primária da tabela departamentos';
...
COMMENT ON TABLE departamentos IS 'Tabela que mostra s departamentos existentes na empresa';
COMMENT ON COLUMN departamentos.id_departamento IS 'chave primária da tabela departamentos';
...
CREATE TABLE historico_cargos (
    ...
    id_departamento INTEGER NOT NULL,
    id_cargo VARCHAR(10) NOT NULL,
    CONSTRAINT id_empregado_e_data_inicial_pk PRIMARY KEY (data_inicial, id_empregado)
);
...
COMMENT ON COLUMN historico_cargos.id_departamento IS 'chave primária';
COMMENT ON COLUMN historico_cargos.id_cargo IS 'chave primaria da tabela';
...
INSERT INTO historico_cargos (id_empregado, data_inicial, data_final, id_cargo, id_departamento) 
VALUES (103, '2001-10-28', '2005-03-15', 'AC_MGR', 110);
INSERT INTO historico_cargos (id_empregado, data_inicial, data_final, id_cargo, id_departamento) 
...
INSERT INTO historico_cargos (id_empregado, data_inicial, data_final, id_cargo, id_departamento) 
VALUES (177, '2007-01-01', '2007-12-31', 'SA_MAN', 80);
INSERT INTO historico_cargos (id_empregado, data_inicial, data_final, id_cargo, id_departamento) 
VALUES (203, '2002-07-01', '2006-12-31', 'AC_ACCOUNT', 90);
