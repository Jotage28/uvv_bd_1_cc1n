...
ALTER TABLE regioes COMMENT 'Contém número e nome das regiões';

ALTER TABLE regioes MODIFY COLUMN id_regiao INTEGER COMMENT 'Chave primária da tabela regiões.';

ALTER TABLE regioes MODIFY COLUMN nome VARCHAR(25) COMMENT 'Nome da regiões';
...
ALTER TABLE paises COMMENT 'Contém as informações dos países';

ALTER TABLE paises MODIFY COLUMN id_pais CHAR(2) COMMENT 'Chave primária da tabela países.';

ALTER TABLE paises MODIFY COLUMN nome VARCHAR(50) COMMENT 'Nome de cada país';
...
ALTER TABLE localizacoes MODIFY COLUMN cep VARCHAR(12) COMMENT 'CEP de um escritório ou facilidade da empresa';

ALTER TABLE localizacoes MODIFY COLUMN cidade VARCHAR(50) COMMENT 'Cidade que se localiza o escritório ou facilidade da empresa';

ALTER TABLE localizacoes MODIFY COLUMN uf VARCHAR(25) COMMENT 'UF que se localiza um escritório ou facilidade da empresa';

ALTER TABLE localizacoes MODIFY COLUMN id_pais CHAR(2) COMMENT 'Chave primária da tabela países.';
...
ALTER TABLE cargos COMMENT 'Tabela que armazena cargos e faixa salarial, contendo mínimo e máximo para cada cargo';

ALTER TABLE cargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'chave primaria da tabela';

ALTER TABLE cargos MODIFY COLUMN cargo VARCHAR(35) COMMENT 'nomde do cargo';

ALTER TABLE cargos MODIFY COLUMN salario_minimo DECIMAL(8, 2) COMMENT 'menor salário possivel para um cargo';

ALTER TABLE cargos MODIFY COLUMN salario_maximo DECIMAL(8, 2) COMMENT 'maior salario possivel para um cargo';
...
ALTER TABLE empregados MODIFY COLUMN comissao DECIMAL(4, 2) COMMENT 's quem trabalha no departamento de vendas';
...
ALTER TABLE departamentos COMMENT 'Tabela que mostra s departamentos existentes na empresa';

ALTER TABLE departamentos MODIFY COLUMN id_departamento INTEGER COMMENT 'chave primária da tabela departamentos';

ALTER TABLE departamentos MODIFY COLUMN nome VARCHAR(20) COMMENT 'Nome do departamento';
...
ALTER TABLE historico_cargos MODIFY COLUMN id_departamento INTEGER COMMENT 'chave primária';

ALTER TABLE historico_cargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'chave primaria da tabela';
...
INSERT INTO cargos (id_cargo, cargo, salario_minimo,
  salario_maximo) VALUES ('AD_PRES', 'President', 20080, 40000);
INSERT INTO cargos (id_cargo, cargo, salario_minimo,
  salario_maximo) VALUES ('AD_VP', 'Administration Vice President', 15000, 30000);
INSERT INTO cargos (id_cargo, cargo, salario_minimo,
...
ALTER TABLE paises ADD CONSTRAINT regioes__paises__fk
FOREIGN KEY (id_regiao)
REFERENCES regioes (id_regiao)
ON DELETE NO ACTION
ON UPDATE NO ACTION;

ALTER TABLE localizacoes ADD CONSTRAINT paises__localizacoes_fk
FOREIGN KEY (id_pais)
...
ALTER TABLE historico_cargos ADD CONSTRAINT cargos_historico_cargos__fk
FOREIGN KEY (id_cargo)
REFERENCES cargos (id_cargo)
ON DELETE NO ACTION
ON UPDATE NO ACTION;
...
ALTER TABLE historico_cargos ADD CONSTRAINT departamentos_historico_cargos__fk
